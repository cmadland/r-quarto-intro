...
read more about it [here](https://intro2r.com/rsprojs.html){target=“_blank”}.
...
![](assets/posit-upload.png){fig-alt="portion of the posit cloud interface with the 'Upload button highlighted"}

Click the "Choose File" option and navigate to the file you want to upload.

![](assets/posit-upload-2.png){fig-alt="portion of the posit cloud interface with the 'Choose File' button visible"}
...
If you want to explore more ways to view and preview the content of our data frames, check out the [Data Analysis with RStudio - Data cleaning and manipulation and visualization](https://uviclibraries.github.io/rstudio-vis/) workshop. You can also go [here](https://intro2r.com/data-structures.html#df){target=“_blank”} for more information about data frames.
...
More on data visualization is covered in the [Data Analysis with RStudio - Data cleaning and manipulation and visualization](https://uviclibraries.github.io/rstudio-vis/) workshop, and more on data analysis, such as statistical tests, is covered in the [Data Analysis with RStudio - Intermediate data analysis](https://uviclibraries.github.io/rstudio-intermediate/) workshop.
...
Median
: The middle value in a sorted set (e.g. lowest - highest).
...
Histogram
: A graph used for understanding and analysing the
...
Great job! Now you know how to use the basic syntax of R in R Studio to calculate basic statistical measures! This is the official end of this workshop.
